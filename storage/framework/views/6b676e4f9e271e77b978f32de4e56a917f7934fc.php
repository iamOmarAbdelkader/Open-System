...
<link rel="stylesheet" href="<?php echo e(asset('adminlte/bower_components/adminlte-rtl/dist/css/AdminLTE-rtl.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('adminlte/bower_components/adminlte-rtl/dist/css/skins/_all-skins-rtl.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('adminlte/bower_components/bootstrap-rtl/dist/css/bootstrap-rtl.min.css')); ?>">
  ...
  <link rel="stylesheet" href="<?php echo e(asset('plugins/iCheck/square/blue.css')); ?>">
    <style>
      ...
      .login-page{
        background: url(<?php echo e(asset('images/login.jpeg')); ?>);
...
<script src="<?php echo e(asset('js/messages_ar.js')); ?>"></script>
<script>
  $(function () {
