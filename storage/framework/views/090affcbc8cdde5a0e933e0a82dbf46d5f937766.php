<?php $__env->startSection('title','التعاملات اليومية'); ?>
    ...
    <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="box-btn">
                    <a class="btn btn-success  btn-sm btn-flat" href="<?php echo e(route('daily.create')); ?>">
                    اضافة
                    </a>   
...
<?php $__env->startPush('scripts'); ?>
              ...
              $('.jstree').jstree({
                "core" : {
                  ...
                  'force_text' : true,
                  "themes" : { "stripes" : true },
                  'data' :<?php echo json_encode(DB::table('trees')->select(['id','type','icon','parent','text'])->get()); ?>
              ...
              $('.jstree').on('rename_node.jstree',function(e , node){
                ...
                var text = node['text']
                  $.ajax({
                  type:'post',
                  url:"<?php echo e(route('tree.update')); ?>",
                  data:{
                    id:id,
                    text:text
                  },
              ...
              $('.jstree').on('delete_node.jstree',function(e,node,parent){
                var id = node.node.id;
                 ...
                 $.ajax({
                  type:'post',
                  url:"<?php echo e(route('tree.destroy')); ?>",
                  data:{
                    ids:ids
                  },
                  success:function(data){
              ...
              $.ajax({
                  type:'post',
                  url:"<?php echo e(route('tree.store')); ?>",
                  data:{
                    item:item
                  },
                  success:function(data){
