...
@section('content')
    <div class="row">
        @if($items->count() and $suppliers->count() and $stores->count())
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" class="validate" action="{{route('orders-out.store')}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
