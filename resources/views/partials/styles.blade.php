 ...
 <!-- Bootstrap 3.3.7 -->
  ...
  <link rel="stylesheet" href="{{asset('adminlte/dist/css/skins/_all-skins.min.css')}}">
	...
	<link rel="stylesheet" href="{{asset('plugins/datatables/new/buttons.dataTables.min.css')}}">    

	<link rel="stylesheet" href="{{asset('plugins/datatables/new/buttons.bootstrap.min.css')}}">    
