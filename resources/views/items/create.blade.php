    ...
    <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" class="validate" action="{{route('items.store')}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
              <div class="box-body">
                ...
                <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text"  required class="form-control" name="details[{{$meta->col_name}}]" id="{{$meta->col_name}}">
                        </div>
                      </div>
                      @endforeach
                </div>
